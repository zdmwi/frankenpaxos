from .rt3multipaxos import *


def main(args) -> None:
    class LatencyThroughputSuite(RT3MultiPaxosSuite):
        ...
        def inputs(self) -> Collection[Input]:
            return ([
                Input(
                    ...
                    num_replicas = 3,
                    num_monitors = 1,
                    client_jvm_heap_size = '7g',
                    leader_jvm_heap_size = '7g',
                    matchmaker_jvm_heap_size = '15g',
                    reconfigurer_jvm_heap_size = '7g',
                    acceptor_jvm_heap_size = '5g',
                    replica_jvm_heap_size = '5g',
                    driver_jvm_heap_size = '1g',
                    monitor_jvm_heap_size = '5g',
                    ...
                    monitor_log_level = args.log_level,
